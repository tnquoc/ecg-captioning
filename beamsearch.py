...
class BeamSearch(object):
    ...
    def _expand_visual(self, visual: network_typing.TensorOrSequence, cur_beam_size: int, selected_beam: torch.Tensor):
    ...
    def apply(self, visual: network_typing.TensorOrSequence, out_size=1, return_probs=False, **kwargs):
    ...
    def iter(self, t: int, visual: network_typing.TensorOrSequence, outputs, state, return_probs, **kwargs):
